...
1. Add the dataset that you will use for model training, and add one of the machine learning modules that creates a classification or regression model.
...
##  <a name="bkmk_Examples"></a> Examples  
 ...
 For examples of how cross-validation is used in machine learning, see these sample experiments in the [Model Gallery](https://gallery.cortanaintelligence.com/):  
