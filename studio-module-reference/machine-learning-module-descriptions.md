...
These modules don't provide data integration tools or pipelines, such as those provided by Azure Data Factory. Instead, the modules in Azure Machine Learning provide functionality that is specific to machine learning:
