...
This article describes the modules in Azure Machine Learning Studio that support use of the Open Source Computer Vision Library. 

OpenCV is an open-source library that supports a variety of image processing and image recognition tasks. For more information, see [http://opencv.org/](http://opencv.org/).  

The modules in Studio provide a way for you to easily incorporate the OpenCV Library into your machine learning experiments.
