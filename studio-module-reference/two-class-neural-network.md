...
2.  Specify how you want the model to be trained, by setting the **Create trainer mode** option.  
    ...
    -   **Parameter Range**: If you are not sure of the best parameters, you can find the optimal parameters by specifying multiple values and using the [Tune Model Hyperparameters](tune-model-hyperparameters.md) module to find the optimal configuration.  The trainer iterates over multiple combinations of the settings and determine the combination of values that produces the best model.
