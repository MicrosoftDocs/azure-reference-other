...
This article describes how to use the [Test Hypothesis Using t-Test](test-hypothesis-using-t-test.md) module in Machine Learning Studio (classic), to generate scores for three types of t-tests:
