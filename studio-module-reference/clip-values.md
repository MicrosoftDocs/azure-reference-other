...
6.  Select the option,  **Add indicator columns**, if you want to generate an indicator column that tells you whether or not the specified clipping operation applies to the data in that row. This option is particularly handy when you are testing a new set of clipping and substitution values.  
...
###  <a name="bkmk_Percentiles"></a> Using Clip Values with Percentiles  
