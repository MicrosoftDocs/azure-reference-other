...
1. Add the **Normalize Data** module to your experiment. You can find the module in Azure Machine Learning Studio, under **Data Transformation**, in the **Scale and Reduce** category.
