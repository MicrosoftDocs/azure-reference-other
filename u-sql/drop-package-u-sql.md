...
---
# DROP PACKAGE (U-SQL)
The `DROP PACKAGE` statement drops packages. As in the case with other meta data objects, a package gets dropped even if another [package](../u-sql/u-sql-packages.md), [table-valued function](../u-sql/u-sql-table-valued-functions.md) or [procedure](../u-sql/u-sql-procedures.md) depends on it.
