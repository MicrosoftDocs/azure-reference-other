...
When more than one logical operator is used in an expression, AND operators bind stronger than [OR](../u-sql/or-u-sql.md) and weaker than [NOT](../u-sql/not-u-sql.md). Parentheses can be used to change the binding precedence. 
