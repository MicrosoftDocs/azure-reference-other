...
When more than one logical operator is used in an expression, AND operators bind stronger than [OR](../USQL/or-u-sql.md) and weaker than [NOT](../USQL/not-u-sql.md). Parentheses can be used to change the binding precedence. 
