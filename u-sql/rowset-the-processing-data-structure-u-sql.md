...
1.  A U-SQL rowset flows through the U-SQL expression flow and only gets persisted with an explicit insertion into a table using an [INSERT](../USQL/insert-u-sql.md) or [CREATE TABLE](../USQL/create-table-u-sql-overview.md) AS statement.  
