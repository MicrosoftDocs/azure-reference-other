...
---
# Extractors.Tsv()
The Tsv() extractor disallows the `delimiter` parameter and defaults the field delimiter to '\t' (tab). All other parameters are the same.   See [Extractor Parameters (U-SQL)](../USQL/extractor-parameters-u-sql.md) for supported parameters and their defaults values.   
