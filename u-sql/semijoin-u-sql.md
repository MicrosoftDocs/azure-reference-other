...
**Additional Example**  
An example of comparing SEMIJOIN against a subquery with IN is available at [Subqueries with IN/NOT IN and SEMIJOIN/ANTISEMIJOIN](../USQL/common-sql-expressions-in-u-sql.md#subQuery).
