...
When more than one logical operator is used in an expression, NOT operators bind stronger than [AND](../USQL/and-u-sql.md) and [OR](../USQL/or-u-sql.md). Parentheses can be used to change the binding precedence. 
