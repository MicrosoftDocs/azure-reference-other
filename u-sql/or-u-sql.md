...
When more than one logical operator is used in an expression, OR operators bind weaker than both [AND](../u-sql/and-u-sql.md) and [NOT](../u-sql/not-u-sql.md). Parentheses can be used to change the binding precedence. 
