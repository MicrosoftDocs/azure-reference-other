...
* `moduleCreate` [IOTHUB_REGISTRY_MODULE_CREATE](function (refid) {
    ...
    }) structure containing the existing deviceID, new module Id, primaryKey (optional) and secondaryKey (optional) 
