...
> [!NOTE]
>  This behavior differs from the [LTRIM](https://docs.microsoft.com/en-us/sql/t-sql/functions/ltrim-transact-sql?view=sql-server-ver15) function of T-SQL, that only removes the space character `(char(32))`
