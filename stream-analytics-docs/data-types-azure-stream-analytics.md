...
| Data type | SQL | Power BI | Document DB | PostgreSQL | Kusto |
|-|-|-|-|-|-|
| **bigint** | bigint, int, smallint, tinyint, all string types (ntext, nvarchar, char, …) | yes | numeric: integer | bigint | Dynamic, init, long |
...
| **record** | Not supported,  "Record" string is outputted | Not supported,  "Record" string is outputted | JSON object | Not supported | Dynamic, bool, long, datetime, byte[], real, double, string |
