...
> [!NOTE]
> When reading bigint datatypes that are outside the range Azure Stream Analytics supports, you can use Azure functions to convert the file format to string.
