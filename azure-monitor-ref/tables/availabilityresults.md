---
title: Azure Monitor Logs reference - availabilityResults
description: Reference for availabilityResults table in Azure Monitor Logs.
ms.topic: reference
...
# availabilityResults
 ...
 Application Insights Availability Results Schema
...
|id|string|Application-defined id.|
...
|duration|real|Number of milliseconds it took to finish the test.|
