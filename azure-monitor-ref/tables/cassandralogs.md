...
| SessionId | string | Unique string identifying what query was running when this log was emitted. Use SHOW SESSION &lt;essionId&gt; to find details of the query's activity. |
