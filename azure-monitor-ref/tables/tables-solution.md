...
- [InboundConnection](inboundconnection.md)
...
- [IISAssessmentRecommendation](iisassessmentrecommendation.md)
...
- [AppCenterError](appcentererror.md)
...
- [AppServiceEnvironmentPlatformLogs](appserviceenvironmentplatformlogs.md)
- [FailedIngestion](failedingestion.md)
- [SucceededIngestion](succeededingestion.md)
- [MicrosoftDataShareShareLog](microsoftdatasharesharelog.md)
...
- [AzureDevOpsAuditing](azuredevopsauditing.md)
...
- [AppServiceAntivirusScanLogs](appserviceantivirusscanlogs.md)
...
- [MAOfficeDeploymentStatusNRT](maofficedeploymentstatusnrt.md)
...
- [SqlDataClassification](sqldataclassification.md)
...
- [SecurityIncident](securityincident.md)
- [Dynamics365Activity](dynamics365activity.md)
