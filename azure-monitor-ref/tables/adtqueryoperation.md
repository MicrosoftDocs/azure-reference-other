...
| QueryCharge | real | The QueryCharge for this event in the trace. See [Query Units](https://learn.microsoft.com/en-us/azure/digital-twins/concepts-query-units) for more information. |
