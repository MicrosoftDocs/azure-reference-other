...
|Etcd Server Leader Changes Seen Total<p><p>The number of leader changes seen |`EtcdServerLeaderChangesSeenTotal` |Count |Average |Component, Pod Name, Tier |No|
|Etcd Server Proposals Applied Total<p><p>The total number of consensus proposals applied |`EtcdServerProposalsAppliedTotal` |Count |Average |Component, Pod Name, Tier |No|
|Etcd Server Proposals Committed Total<p><p>The total number of consensus proposals committed |`EtcdServerProposalsCommittedTotal` |Count |Average |Component, Pod Name, Tier |No|
|Etcd Server Proposals Failed Total<p><p>The total number of failed proposals |`EtcdServerProposalsFailedTotal` |Count |Average |Component, Pod Name, Tier |No|
|Etcd Server Slow Apply Total (Preview)<p><p>The total number of slow apply requests |`EtcdServerSlowApplyTotal` |Count |Average |Pod Name, Tier |No|
...
|Felix IP Tables Restore Errors<p><p>Number of 'iptables-restore' errors |`FelixIptablesRestoreErrors` |Count |Average |Host |No|
|Felix IP Tables Save Errors<p><p>Number of 'iptables-save' errors |`FelixIptablesSaveErrors` |Count |Average |Host |No|
|Felix Resyncs Started<p><p>Number of times Felix has started resyncing with the datastore |`FelixResyncsStarted` |Count |Average |Host |No|
|Felix Resync State<p><p>Current datastore state |`FelixResyncState` |Unspecified |Average |Host |No|
|Daemonsets Current Number Scheduled<p><p>Number of daemonsets currently scheduled |`KubeDaemonsetStatusCurrentNumberScheduled` |Count |Average |Daemonset, Namespace |No|
|Daemonsets Desired Number Scheduled<p><p>Number of daemonsets desired scheduled |`KubeDaemonsetStatusDesiredNumberScheduled` |Count |Average |Daemonset, Namespace |No|
|Deployment Replicas Available<p><p>Number of deployment replicas available |`KubeDeploymentStatusReplicasAvailable` |Count |Average |Deployment, Namespace |No|
|Deployment Replicas Ready<p><p>Number of deployment replicas ready |`KubeDeploymentStatusReplicasReady` |Count |Average |Deployment, Namespace |No|
|Jobs Active<p><p>Number of jobs active |`KubeJobStatusActive` |Count |Average |Job, Namespace |No|
|Jobs Failed<p><p>Number and reason of jobs failed |`KubeJobStatusFailed` |Count |Average |Job, Namespace, Reason |No|
|Jobs Succeeded<p><p>Number of jobs succeeded |`KubeJobStatusSucceeded` |Count |Average |Job, Namespace |No|
|Kubelet Running Containers<p><p>Number of containers currently running |`KubeletRunningContainers` |Count |Average |Container State, Host |No|
|Kubelet Running Pods<p><p>Number of pods running on the node |`KubeletRunningPods` |Count |Average |Host |No|
|Kubelet Runtime Operations Errors Total<p><p>Cumulative number of runtime operation errors by operation type |`KubeletRuntimeOperationsErrorsTotal` |Count |Average |Host, Operation Type |No|
|Kubelet Started Pods Errors Total<p><p>Cumulative number of errors when starting pods |`KubeletStartedPodsErrorsTotal` |Count |Average |Host |No|
|Volume Available Bytes<p><p>Number of available bytes in the volume |`KubeletVolumeStatsAvailableBytes` |Bytes |Average |Host, Namespace, Persistent Volume Claim |No|
|Volume Capacity Bytes<p><p>Capacity (in bytes) of the volume |`KubeletVolumeStatsCapacityBytes` |Bytes |Average |Host, Namespace, Persistent Volume Claim |No|
|Volume Used Bytes<p><p>Number of used bytes in the volume |`KubeletVolumeStatsUsedBytes` |Bytes |Average |Host, Namespace, Persistent Volume Claim |No|
|Node Resources Allocatable<p><p>Node resources allocatable for pods |`KubeNodeStatusAllocatable` |Count |Average |Node, Resource, Unit |No|
|Node Resources Capacity<p><p>Total amount of node resources available |`KubeNodeStatusCapacity` |Count |Average |Node, Resource, Unit |No|
|Node Status Condition<p><p>The condition of a node |`KubeNodeStatusCondition` |Count |Average |Condition, Node, Status |No|
|Container Resources Limits<p><p>The container's resources limits |`KubePodContainerResourceLimits` |Count |Average |Container, Namespace, Node, Pod, Resource, Unit |No|
|Container Resources Requests<p><p>The container's resources requested |`KubePodContainerResourceRequests` |Count |Average |Container, Namespace, Node, Pod, Resource, Unit |No|
|Container State Started (Preview)<p><p>Unix timestamp start time of a container |`KubePodContainerStateStarted` |Count |Average |Container, Namespace, Pod |No|
|Container Status Last Terminated Reason<p><p>The reason of a container's last terminated status |`KubePodContainerStatusLastTerminatedReason` |Count |Average |Container, Namespace, Pod, Reason |No|
|Container Status Ready<p><p>Describes whether the container's readiness check succeeded |`KubePodContainerStatusReady` |Count |Average |Container, Namespace, Pod |No|
|Container Restarts<p><p>The number of container restarts |`KubePodContainerStatusRestartsTotal` |Count |Average |Container, Namespace, Pod |No|
|Container Status Running<p><p>The number of containers with a status of 'running' |`KubePodContainerStatusRunning` |Count |Average |Container, Namespace, Pod |No|
|Container Status Terminated<p><p>The number of containers with a status of 'terminated' |`KubePodContainerStatusTerminated` |Count |Average |Container, Namespace, Pod |No|
|Container Status Terminated Reason<p><p>The number and reason of containers with a status of 'terminated' |`KubePodContainerStatusTerminatedReason` |Count |Average |Container, Namespace, Pod, Reason |No|
|Container Status Waiting<p><p>The number of containers with a status of 'waiting' |`KubePodContainerStatusWaiting` |Count |Average |Container, Namespace, Pod |No|
|Container Status Waiting Reason<p><p>The number and reason of containers with a status of 'waiting' |`KubePodContainerStatusWaitingReason` |Count |Average |Container, Namespace, Pod, Reason |No|
|Pod Deletion Timestamp (Preview)<p><p>The timestamp of the pod's deletion |`KubePodDeletionTimestamp` |Count |Average |Namespace, Pod |No|
|Pod Init Container Ready<p><p>The number of ready pod init containers |`KubePodInitContainerStatusReady` |Count |Average |Namespace, Container, Pod |No|
|Pod Init Container Restarts<p><p>The number of pod init containers restarts |`KubePodInitContainerStatusRestartsTotal` |Count |Average |Namespace, Container, Pod |No|
|Pod Init Container Running<p><p>The number of running pod init containers |`KubePodInitContainerStatusRunning` |Count |Average |Namespace, Container, Pod |No|
|Pod Init Container Terminated<p><p>The number of terminated pod init containers |`KubePodInitContainerStatusTerminated` |Count |Average |Namespace, Container, Pod |No|
|Pod Init Container Terminated Reason<p><p>The number of pod init containers with terminated reason |`KubePodInitContainerStatusTerminatedReason` |Count |Average |Namespace, Container, Pod, Reason |No|
|Pod Init Container Waiting<p><p>The number of pod init containers waiting |`KubePodInitContainerStatusWaiting` |Count |Average |Namespace, Container, Pod |No|
|Pod Init Container Waiting Reason<p><p>The reason the pod init container is waiting |`KubePodInitContainerStatusWaitingReason` |Count |Average |Namespace, Container, Pod, Reason |No|
|Pod Status Phase<p><p>The pod status phase |`KubePodStatusPhase` |Count |Average |Namespace, Pod, Phase |No|
|Pod Ready State<p><p>Signifies if the pod is in ready state |`KubePodStatusReady` |Count |Average |Namespace, Pod |No|
|Pod Status Reason<p><p>NodeAffinity |`KubePodStatusReason` |Count |Average |Namespace, Pod, Reason |No|
|Statefulset Desired Replicas Number<p><p>The desired number of statefulset replicas |`KubeStatefulsetReplicas` |Count |Average |Namespace, Statefulset |No|
|Statefulset Replicas Number<p><p>The number of replicas per statefulset |`KubeStatefulsetStatusReplicas` |Count |Average |Namespace, Statefulset |No|
|Kubevirt Info<p><p>Kubevirt version information |`KubevirtInfo` |Unspecified |Average |Kube Version |No|
