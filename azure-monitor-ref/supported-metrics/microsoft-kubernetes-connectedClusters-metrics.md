...
|---|---|---|---|---|---|
|Total number of cpu cores in a connected cluster<p><p>Total number of cpu cores in a connected cluster |`capacity_cpu_cores` |Count |Total |No Dimensions |Yes|
