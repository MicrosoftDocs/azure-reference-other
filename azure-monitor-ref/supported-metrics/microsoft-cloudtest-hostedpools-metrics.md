...
For a list of supported logs, see [Supported log categories - Microsoft.Cloudtest/hostedpools](../supported-logs/microsoft-cloudtest-hostedpools-logs.md)  
  
 

[!INCLUDE[Microsoft.Cloudtest/hostedpools](./includes/microsoft-cloudtest-hostedpools-metrics-include.md)]
