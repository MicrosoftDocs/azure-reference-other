...
|Queue Capacity<p><p>The amount of Queue storage used by the storage account. |`QueueCapacity` |Bytes |Average |No Dimensions |Yes|
|Queue Count<p><p>The number of queues in the storage account. |`QueueCount` |Count |Average |No Dimensions |Yes|
|Queue Message Count<p><p>The number of unexpired queue messages in the storage account. |`QueueMessageCount` |Count |Average |No Dimensions |Yes|
