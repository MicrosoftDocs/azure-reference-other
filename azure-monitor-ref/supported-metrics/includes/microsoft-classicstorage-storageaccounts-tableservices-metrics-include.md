...
|Capacity|**Table Capacity**<br><br>The amount of storage used by the storage account's Table service in bytes. |`TableCapacity` |Bytes |Average |\<none\>|PT1H |No|
|Capacity|**Table Count**<br><br>The number of table in the storage account's Table service. |`TableCount` |Count |Average |\<none\>|PT1H |No|
|Capacity|**Table Entity Count**<br><br>The number of table entities in the storage account's Table service. |`TableEntityCount` |Count |Average |\<none\>|PT1H |No|
