...
|Capacity|**Queue Capacity**<p><p>The amount of storage used by the storage account's Queue service in bytes. |`QueueCapacity` |Bytes |Average |\<none\>|PT1H |Yes|
|Capacity|**Queue Count**<p><p>The number of queue in the storage account's Queue service. |`QueueCount` |Count |Average |\<none\>|PT1H |Yes|
|Capacity|**Queue Message Count**<p><p>The approximate number of queue messages in the storage account's Queue service. |`QueueMessageCount` |Count |Average |\<none\>|PT1H |Yes|
