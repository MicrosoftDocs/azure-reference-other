...
|---|---|---|---|---|---|---|
|Dedicated Core Count<p><p>Total number of dedicated cores in the batch account |`CoreCount` |Count |Total |No Dimensions|PT1M |No|
|Creating Node Count<p><p>Number of nodes being created |`CreatingNodeCount` |Count |Total |No Dimensions|PT1M |No|
|Idle Node Count<p><p>Number of idle nodes |`IdleNodeCount` |Count |Total |No Dimensions|PT1M |No|
...
|Leaving Pool Node Count<p><p>Number of nodes leaving the Pool |`LeavingPoolNodeCount` |Count |Total |No Dimensions|PT1M |No|
|LowPriority Core Count<p><p>Total number of low-priority cores in the batch account |`LowPriorityCoreCount` |Count |Total |No Dimensions|PT1M |No|
|Offline Node Count<p><p>Number of offline nodes |`OfflineNodeCount` |Count |Total |No Dimensions|PT1M |No|
...
|Preempted Node Count<p><p>Number of preempted nodes |`PreemptedNodeCount` |Count |Total |No Dimensions|PT1M |No|
|Rebooting Node Count<p><p>Number of rebooting nodes |`RebootingNodeCount` |Count |Total |No Dimensions|PT1M |No|
|Reimaging Node Count<p><p>Number of reimaging nodes |`ReimagingNodeCount` |Count |Total |No Dimensions|PT1M |No|
|Running Node Count<p><p>Number of running nodes |`RunningNodeCount` |Count |Total |No Dimensions|PT1M |No|
|Starting Node Count<p><p>Number of nodes starting |`StartingNodeCount` |Count |Total |No Dimensions|PT1M |No|
|Start Task Failed Node Count<p><p>Number of nodes where the Start Task has failed |`StartTaskFailedNodeCount` |Count |Total |No Dimensions|PT1M |No|
...
|Low-Priority Node Count<p><p>Total number of low-priority nodes in the batch account |`TotalLowPriorityNodeCount` |Count |Total |No Dimensions|PT1M |No|
|Dedicated Node Count<p><p>Total number of dedicated nodes in the batch account |`TotalNodeCount` |Count |Total |No Dimensions|PT1M |No|
|Unusable Node Count<p><p>Number of unusable nodes |`UnusableNodeCount` |Count |Total |No Dimensions|PT1M |No|
|Waiting For Start Task Node Count<p><p>Number of nodes waiting for the Start Task to complete |`WaitingForStartTaskNodeCount` |Count |Total |No Dimensions|PT1M |No|