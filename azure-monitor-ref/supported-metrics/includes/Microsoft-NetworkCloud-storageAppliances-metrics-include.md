...
|Nexus Storage Array Queue Depth<p><p>Storage array queue depth |`PurefaArrayPerformanceQdepth` |Bytes |Average |No Dimensions|PT1M |No|
|Nexus Storage Array Capacity Bytes<p><p>Storage array overall space capacity |`PurefaArraySpaceCapacityBytes` |Bytes |Average |No Dimensions|PT1M |No|
|Nexus Storage Array Space DDR<p><p>Storage array overall data reduction |`PurefaArraySpaceDatareductionRatio` |Percent |Average |No Dimensions|PT1M |No|
|Nexus Storage Array Space Prov<p><p>Storage array overall provisioned space |`PurefaArraySpaceProvisionedBytes` |Bytes |Average |No Dimensions|PT1M |No|
