...
|Storage Array|**Nexus Storage Array Space DDR**<br><br>Storage array overall data reduction |`PurefaArraySpaceDatareductionRatio` |Count |Average |\<none\>|PT1M |No|
...
|Host|**Nexus Storage Host Space DDR**<br><br>Storage array host volumes data reduction ratio |`PurefaHostSpaceDatareductionRatio` |Count |Average |`Host`|PT1M |No|
