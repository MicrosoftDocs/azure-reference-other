...
|Large App Service Plan Workers<p><p>Large App Service Plan Workers |`LargeAppServicePlanInstances` |Count |Average |No Dimensions|PT1M |Yes|
|Medium App Service Plan Workers<p><p>Medium App Service Plan Workers |`MediumAppServicePlanInstances` |Count |Average |No Dimensions|PT1M |Yes|
...
|Small App Service Plan Workers<p><p>Small App Service Plan Workers |`SmallAppServicePlanInstances` |Count |Average |No Dimensions|PT1M |Yes|
|Total Front Ends<p><p>Total Front Ends |`TotalFrontEnds` |Count |Average |No Dimensions|PT1M |Yes|