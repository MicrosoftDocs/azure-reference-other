...
|**Table Capacity**<p><p>The amount of Table storage used by the storage account. |`TableCapacity` |Bytes |Average |\<none\>|PT1H |Yes|
|**Table Count**<p><p>The number of tables in the storage account. |`TableCount` |Count |Average |\<none\>|PT1H |Yes|
|**Table Entity Count**<p><p>The number of table entities in the storage account. |`TableEntityCount` |Count |Average |\<none\>|PT1H |Yes|
