...
|Cassandra Connector Average ReplicationLatency<p><p>Cassandra Connector Average ReplicationLatency |`CassandraConnectorAvgReplicationLatency` |MilliSeconds |Average |No Dimensions|PT5M |No|
...
|Account Created<p><p>Account Created |`CreateAccount` |Count |Count |No Dimensions|PT5M |Yes|
...
|Account Deleted<p><p>Account Deleted |`DeleteAccount` |Count |Count |No Dimensions|PT5M |Yes|
...
|Region Failed Over<p><p>Region Failed Over |`RegionFailover` |Count |Count |No Dimensions|PT5M |Yes|
...
|Service Availability<p><p>Account requests availability at one hour, day or month granularity |`ServiceAvailability` |Percent |Minimum, Average, Maximum |No Dimensions|PT1H |No|
...
|Account Network Settings Updated<p><p>Account Network Settings Updated |`UpdateAccountNetworkSettings` |Count |Count |No Dimensions|PT5M |Yes|
