...
|**Disk Read Bytes**<br><br>Bytes read from disk during monitoring period |`Disk Read Bytes` |Bytes |Total |`VMName`|PT1M |Yes|
|**Disk Read Operations/Sec**<br><br>Disk Read IOPS |`Disk Read Operations/Sec` |CountPerSecond |Average |`VMName`|PT1M |Yes|
|**Disk Write Bytes**<br><br>Bytes written to disk during monitoring period |`Disk Write Bytes` |Bytes |Total |`VMName`|PT1M |Yes|
...
|**Network In Billable (Deprecated)**<br><br>The number of billable bytes received on all network interfaces by the Virtual Machine(s) (Incoming Traffic) (Deprecated) |`Network In` |Bytes |Total |`VMName`|PT1M |Yes|
