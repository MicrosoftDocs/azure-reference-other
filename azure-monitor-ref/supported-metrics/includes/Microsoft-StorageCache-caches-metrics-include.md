...
|---|---|---|---|---|---|---|
|Total Client IOPS<p><p>The rate of client file operations processed by the Cache. |`ClientIOPS` |Count |Minimum, Maximum, Average |No Dimensions|PT1M |Yes|
|Average Client Latency<p><p>Average latency of client file operations to the Cache. |`ClientLatency` |MilliSeconds |Minimum, Maximum, Average |No Dimensions|PT1M |Yes|
|Client Lock IOPS<p><p>Client file locking operations per second. |`ClientLockIOPS` |CountPerSecond |Minimum, Maximum, Average |No Dimensions|PT1M |Yes|
|Client Metadata Read IOPS<p><p>The rate of client file operations sent to the Cache, excluding data reads, that do not modify persistent state. |`ClientMetadataReadIOPS` |CountPerSecond |Minimum, Maximum, Average |No Dimensions|PT1M |Yes|
|Client Metadata Write IOPS<p><p>The rate of client file operations sent to the Cache, excluding data writes, that modify persistent state. |`ClientMetadataWriteIOPS` |CountPerSecond |Minimum, Maximum, Average |No Dimensions|PT1M |Yes|
|Client Read IOPS<p><p>Client read operations per second. |`ClientReadIOPS` |CountPerSecond |Minimum, Maximum, Average |No Dimensions|PT1M |Yes|
|Average Cache Read Throughput<p><p>Client read data transfer rate. |`ClientReadThroughput` |BytesPerSecond |Minimum, Maximum, Average |No Dimensions|PT1M |Yes|
...
|Client Write IOPS<p><p>Client write operations per second. |`ClientWriteIOPS` |CountPerSecond |Minimum, Maximum, Average |No Dimensions|PT1M |Yes|
|Average Cache Write Throughput<p><p>Client write data transfer rate. |`ClientWriteThroughput` |BytesPerSecond |Minimum, Maximum, Average |No Dimensions|PT1M |Yes|
...
|Storage Target Health<p><p>Boolean results of connectivity test between the Cache and Storage Targets. |`StorageTargetHealth` |Count |Minimum, Maximum, Average |No Dimensions|PT1M |Yes|
