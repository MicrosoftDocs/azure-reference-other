...
|Usage - ContentSafety|**Call Count for Image Moderation**<br><br>Number of calls for image moderation. |`ContentSafetyImageAnalyzeRequestCount` |Count |Total |`ApiVersion`|PT1M |Yes|
|Usage - ContentSafety|**Call Count for Text Moderation**<br><br>Number of calls for text moderation. |`ContentSafetyTextAnalyzeRequestCount` |Count |Total |`ApiVersion`|PT1M |Yes|
