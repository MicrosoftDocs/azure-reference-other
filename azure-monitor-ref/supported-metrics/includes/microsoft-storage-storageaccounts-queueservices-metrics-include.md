...
|Capacity|**Queue Capacity**<br><br>The amount of Queue storage used by the storage account. |`QueueCapacity` |Bytes |Average |\<none\>|PT1H |Yes|
|Capacity|**Queue Count**<br><br>The number of queues in the storage account. |`QueueCount` |Count |Average |\<none\>|PT1H |Yes|
|Capacity|**Queue Message Count**<br><br>The number of unexpired queue messages in the storage account. |`QueueMessageCount` |Count |Average |\<none\>|PT1H |Yes|
