...
|**Queue Capacity**<p><p>The amount of Queue storage used by the storage account. |`QueueCapacity` |Bytes |Average |\<none\>|PT1H |Yes|
|**Queue Count**<p><p>The number of queues in the storage account. |`QueueCount` |Count |Average |\<none\>|PT1H |Yes|
|**Queue Message Count**<p><p>The number of unexpired queue messages in the storage account. |`QueueMessageCount` |Count |Average |\<none\>|PT1H |Yes|
