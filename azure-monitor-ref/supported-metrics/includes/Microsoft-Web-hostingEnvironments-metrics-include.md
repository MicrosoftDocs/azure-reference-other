...
|Large App Service Plan Workers<p><p>Number of large App Service Plan worker instances |`LargeAppServicePlanInstances` |Count |Average |No Dimensions|PT1M |Yes|
|Medium App Service Plan Workers<p><p>Number of medium App Service Plan worker instances |`MediumAppServicePlanInstances` |Count |Average |No Dimensions|PT1M |Yes|
...
|Small App Service Plan Workers<p><p>Number of small App Service Plan worker instances |`SmallAppServicePlanInstances` |Count |Average |No Dimensions|PT1M |Yes|
|Total Front Ends<p><p>Number of front end instances |`TotalFrontEnds` |Count |Average |No Dimensions|PT1M |Yes|