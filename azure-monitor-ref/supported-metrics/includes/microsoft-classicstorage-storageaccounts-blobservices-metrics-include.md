...
|Capacity|**Blob Count**<p><p>The number of Blob in the storage account's Blob service. |`BlobCount` |Count |Average |`BlobType`, `Tier`|PT1H |No|
|Capacity|**Blob Container Count**<p><p>The number of containers in the storage account's Blob service. |`ContainerCount` |Count |Average |\<none\>|PT1H |No|
...
|Capacity|**Index Capacity**<p><p>The amount of storage used by ADLS Gen2 (Hierarchical) Index in bytes. |`IndexCapacity` |Bytes |Average |\<none\>|PT1H |No|
