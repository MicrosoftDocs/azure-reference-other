...
|**Blob Container Count**<p><p>The number of containers in the storage account's Blob service. |`ContainerCount` |Count |Average |\<none\>|PT1H |No|
...
|**Index Capacity**<p><p>The amount of storage used by ADLS Gen2 (Hierarchical) Index in bytes. |`IndexCapacity` |Bytes |Average |\<none\>|PT1H |No|
