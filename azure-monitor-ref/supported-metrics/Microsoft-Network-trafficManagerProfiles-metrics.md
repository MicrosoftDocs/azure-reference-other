...
|---|---|---|---|---|---|
|Endpoint Status by Endpoint<p><p>1 if an endpoint's probe status is "Enabled", 0 otherwise. |`ProbeAgentCurrentEndpointStateByProfileResourceId` |Count |Maximum |EndpointName |Yes|
|Queries by Endpoint Returned<p><p>Number of times a Traffic Manager endpoint was returned in the given time frame |`QpsByEndpoint` |Count |Total |EndpointName |Yes|
