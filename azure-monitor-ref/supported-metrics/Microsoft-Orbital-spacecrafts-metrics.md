...
|---|---|---|---|---|---|
|Contact Failure Count<p><p>Denotes the number of failed Contacts for a specific Spacecraft |`ContactFailure` |Count |Count |No Dimensions |Yes|
|Contact Success Count<p><p>Denotes the number of successful Contacts for a specific Spacecraft |`ContactSuccess` |Count |Count |No Dimensions |Yes|
