...
|---|---|---|---|---|---|
|Failed Runs<p><p>Failed Runs |`FailedRuns` |Count |Total |pipelineName, activityName |Yes|
|Successful Runs<p><p>Successful Runs |`SuccessfulRuns` |Count |Total |pipelineName, activityName |Yes|
