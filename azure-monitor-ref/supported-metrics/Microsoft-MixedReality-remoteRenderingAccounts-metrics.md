...
|---|---|---|---|---|---|
|Active Rendering Sessions<p><p>Total number of active rendering sessions |`ActiveRenderingSessions` |Count |Average |SessionType, SDKVersion |Yes|
|Assets Converted<p><p>Total number of assets converted |`AssetsConverted` |Count |Total |SDKVersion |Yes|
