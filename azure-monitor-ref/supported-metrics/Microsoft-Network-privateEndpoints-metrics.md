...
|---|---|---|---|---|---|
|Bytes In<p><p>Total number of Bytes Out |`PEBytesIn` |Count |Total |No Dimensions |No|
|Bytes Out<p><p>Total number of Bytes Out |`PEBytesOut` |Count |Total |No Dimensions |No|
