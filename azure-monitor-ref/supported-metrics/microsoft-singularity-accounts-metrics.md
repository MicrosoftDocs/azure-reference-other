...
|---|---|---|---|---|---|
|GpuUtilizationPercentage<p><p>GPU utilization percentage |`GpuUtilizationPercentage` |Percent |Average |accountname, ClusterName, Environment, instance, jobContainerId, jobInstanceId, jobname, Region |Yes|
