...
|MQTT: Dropped Sessions<p><p>The number of dropped sessions by the namespace. |`Mqtt.DroppedSessions` |Count |Total |DropReason |Yes|
...
|MQTT: Failed Routed Messages<p><p>The number of failed routed messages by the namespace. |`Mqtt.FailedRoutedMessages` |Count |Total |Error |Yes|
...
|MQTT: Successful Routed Messages<p><p>The number of successful routed messages by the namespace. |`Mqtt.SuccessfulRoutedMessages` |Count |Total |No Dimensions |Yes|
