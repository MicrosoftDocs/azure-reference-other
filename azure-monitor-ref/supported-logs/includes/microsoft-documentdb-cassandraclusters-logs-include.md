...
|`CassandraLogs` |CassandraLogs |[CassandraLogs](/azure/azure-monitor/reference/tables/cassandralogs)<p>Cassandra general logging messages (system.log).|No|No|[Queries](../../queries/cassandralogs.md)|Yes |